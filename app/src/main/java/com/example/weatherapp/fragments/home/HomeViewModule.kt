...
class HomeViewModule(private val weatherDataRepository: WeatherDataRepository) : ViewModel() {
    ...
    private fun updateAddressText(currentLocation: WeatherData.CurrentLocation , geocoder: Geocoder){
        viewModelScope.launch{
